  ...
  return (
    <>
      ...
      <Main className={styles.myname}>
        ...
        <p>{langFlag ? 'Na stronie znajdą Państwo proste menu składające się na technologie, z którymi jestem zaznajomiony oraz moje portfolio prac niekomercyjnych — aktualizowane na bieżąco.' : 'On the website you will find a simple menu of technologies with which I am familiar and my portfolio of non-commercial works — updated on a regular basis.'}</p>
        <p>Hobby:</p>
